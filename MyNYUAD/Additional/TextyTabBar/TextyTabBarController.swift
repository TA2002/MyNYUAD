...
class TextyTabBarController: UITabBarController, UITabBarControllerDelegate {
    ...
    private func createButtonsStack(_ viewControllers: [UIViewController]) {
        ...
        for (index, viewController) in viewControllers.enumerated() {
            ...
            button.titleEdgeInsets = UIEdgeInsets(top: 0, left: isArabic ? 0 : 0, bottom: 0, right: isArabic ? 0 : 0)
            button.imageEdgeInsets = UIEdgeInsets(top: 0, left: isArabic ? 0 : 0, bottom: 0, right: isArabic ? 0 : 0)
            if index == 0 {
